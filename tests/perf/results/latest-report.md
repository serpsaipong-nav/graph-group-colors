...
- A1: pass (A1 Additive overhead at 500 visible nodes, all multi-color. actual=0.1283ms, target=<= 1ms)
- A2: pass (A2 Additive overhead at 2,000 visible nodes, all multi-color. actual=0.4576ms, target=<= 4ms)
- A3: pass (A3 Additive overhead at 500 nodes, 0% multi-color. actual=0.0393ms, target=<= 0.1ms)
- B1: pass (B1 Perf toggles OFF should not regress active simulation. actual=0%, target=>= 0%)
- B2: pass (B2 Perf toggles ON active simulation improvement target. actual=31.8224%, target=20% to 40%)
- B3: pass (B3 Idle panning should stay within +/-10% of stock. actual=2.317%, target=-10% to 10%)
- LIFECYCLE_ATTACH_MS: pass (LIFECYCLE_ATTACH_MS Initial attach latency. actual=0.019ms, target=<= 150ms)
- LIFECYCLE_UNLOAD_MS: pass (LIFECYCLE_UNLOAD_MS Unload latency. actual=0.164ms, target=<= 50ms)
